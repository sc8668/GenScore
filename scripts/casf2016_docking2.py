...
if args['device'] == 'cpu':
	results1 = Parallel(n_jobs=-1, backend="threading")(delayed(score_compoundxxx)(pdbid, "v2020-refined") for pdbid in ids1)
	results2 = Parallel(n_jobs=-1, backend="threading")(delayed(score_compoundxxx)(pdbid, "v2020-other-PL") for pdbid in ids2)
